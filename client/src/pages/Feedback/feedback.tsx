    ...
    <div className="min-h-screen bg-zinc-900 text-white p-6 md:p-10 font-sans">
      <header className="mb-10">
        ...
        <p className="text-gray-400">
          We value your opinion! Help us improve your experience by sharing your
          thoughts.
        </p>
      </header>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-8 p-4 bg-zinc-700/50 rounded-lg">
            <p className="text-sm text-gray-300">
              If you require a direct response, please ensure your profile
              information (email/phone) is up-to-date.
            </p>
          </div>

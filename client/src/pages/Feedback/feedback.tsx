    ...
    const addEvent = async (eventData: NewEvent) => {
        ...
        try {
            ...
            const event = {
                ...
                attendees: eventData.attendees.split(',').map(email => ({ email: email.trim() })).filter(attendee => attendee.email)
            };
                                ...
                                return (
                                    <div
                                        ...
                                        className={`min-h-24 p-2 border border-gray-700 rounded-lg ${
                                            isCurrentMonth ? 'bg-gray-800' : 'bg-gray-900 text-gray-600'
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-white font-semibold">
                                        {events.filter(e => e.summary.toLowerCase().includes('meeting')).length}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 max-w-md w-full p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-1">Attendees (comma separated)</label>
                                <input
                                    type="text"

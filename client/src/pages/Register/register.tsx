...
import { Eye, EyeOff, Mail, Lock, User, Phone, Briefcase, Star, Zap, Users, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="flex justify-between space-x-4">
        ...
        <button
          type="submit"
          disabled={isLoading || !formData.department || !formData.password || !formData.confirmPassword || !formData.agreeToTerms || formData.password !== formData.confirmPassword}
          className="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-800 to-gray-900 p-12 flex-col justify-between">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-300 text-lg">
              Register to access the centralized command center for data architects and cloud operations teams.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="flex items-center space-x-4 p-4 bg-gray-800/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Real-time insights and automated optimization</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-800/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Integrated communication and project management</p>
              </div>
            </div>
        ...
        <div className="text-sm text-gray-400">
          <p>Already have an account? <button className="text-blue-400 hover:text-blue-300 underline">Sign in here</button></p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-700">
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className={`flex items-center ${step >= 2 ? 'text-blue-400' : 'text-gray-500'}`}>
                ...
                <span className="ml-2 text-sm font-medium">Work & Security</span>
              </div>
            </div>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">
                {step === 1 ? 'Enter your personal details to get started' : 'Complete your work profile and security settings'}
              </p>
            </div>
            ...
            <div className="lg:hidden text-center mt-6 pt-4 border-t border-gray-700">
              <p className="text-sm text-gray-400">
                Already have an account? <button className="text-blue-400 hover:text-blue-300 font-semibold transition">Sign in</button>
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700 rounded-lg">
            <p className="text-sm text-blue-300 text-center">
              <strong>Enterprise Security:</strong> All data is encrypted and protected by enterprise-grade security measures.
            </p>
          </div>
        </div>
      </div>

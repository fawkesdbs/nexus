...
const LightStars: React.FC = () => {
  ...
  return (
    <div className="dark">
      {/* Navigation Bar */}
      <nav className="fixed w-full z-50 bg-opacity-90 backdrop-blur-sm" style={{ backgroundColor: 'hsl(0, 0%, 6%)' }}>
        <div className="container mx-auto px-6 py-4">
          ...
          <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden mt-4 pb-4`}>
            ...
            <button className="mt-4 bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold py-2 px-6 rounded-lg transition-colors w-full">
              Get Started
            </button>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section id="hero" className="hero-bg min-h-screen flex items-center justify-center pt-16">
        <div className="container mx-auto px-6 py-20 text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-xl md:text-2xl mb-10 text-gray-300">
              LightStars is the next-generation command center for data architects, providing centralized AI-driven tools to manage complex cloud infrastructure, automate deployment pipelines, and visualize real-time operational data.
            </p>
            <p className="text-lg md:text-xl mb-12 text-gray-400">
              Our platform simplifies IT operations, allowing your team to focus on innovation rather than maintenance. Join us in streamlining the future of operations.
            </p>
            <button className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-4 px-10 rounded-lg text-lg transition-all transform hover:scale-105">
              Get Started
            </button>
          </div>
        </div>
      ...
      <section id="services" className="py-20" style={{ backgroundColor: 'hsl(0, 0%, 10%)' }}>
      ...
      {/* Footer */}
      <footer id="about" className="py-12 border-t border-gray-800" style={{ backgroundColor: 'hsl(0, 0%, 6%)' }}>
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold gradient-text mb-4">LightStars</h3>
              <p className="text-gray-400">
                Revolutionizing data architecture with AI-driven solutions for the modern enterprise.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-gray-400 hover:text-yellow-500 transition-colors text-xl">
...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description }) => (
  <div className="bg-opacity-20 backdrop-blur-sm rounded-xl p-8 border border-gray-700 hover:border-yellow-500 transition-colors" style={{ backgroundColor: 'hsl(0, 0%, 8%)' }}>
...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ stars, quote, name, position, image }) => (
  <div className="bg-opacity-20 backdrop-blur-sm rounded-xl p-8 border border-gray-700" style={{ backgroundColor: 'hsl(0, 0%, 8%)' }}>
